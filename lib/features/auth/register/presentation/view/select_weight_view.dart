...
class SelectWeightView extends StatefulWidget {
  ...
  @override
  State<SelectWeightView> createState() => _SelectWeightViewState();
}

class _SelectWeightViewState extends State<SelectWeightView> {
  static const int _minWeight = 30;
  static const int _maxWeight = 200;
  static const int _initialWeight = 65;

  int _selectedWeight = _initialWeight;
  ...
  void _onNextPressed() {
    ...
    context.push(
      RoutePath.selectHeightRoute,
      extra: data.copyWith(weight: _selectedWeight),
    );
  }
